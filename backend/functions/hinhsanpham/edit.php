        ...
        */
        ...
        <form name="frmhinhsanpham" id="frmhinhanpham" method="post" action="" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <br />
            <img src="/duan-web02/assests/uploads/products/<?= $hinhsanphamRow['hsp_tentaptin'] ?>" class="img-fluid" width="300px" />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="preview-img-container">
              <img src="/duan-web02/assests/shared/img/default-image_600.png" id="preview-img" width="200px" />
            </div>
        ...
        if (isset($_POST['btnSave'])) {
          ...
          if (isset($_FILES['hsp_tentaptin'])) {
            ...
            // Ví dụ: các file upload sẽ được lưu vào thư mục ../../../assests/uploads
