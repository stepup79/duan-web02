...
<body>
    ...
    <div class="container mt-2">
            ...
            <div class="row">
                <div class="col col-md-6">
                    <!-- <img src="/duan-web02/assets/frontend/img/marketing-1.png" class="img-fluid" /> -->
                </div>
                <div class="col col-md-6">
        ...
        if (isset($_POST['btnGuiLoiNhan'])) {
            ...
            try {
                ...
                $mail->Username = 'thaiduy6995@gmail.com';              // SMTP username
                $mail->Password = 'nlotgwilwamadqud';                   // SMTP password
                ...
                //Recipients
                $mail->setFrom('thaiduy6995@gmail.com', 'Mail Liên hệ');
                $mail->addAddress('thaiduy6995@gmail.com');               // Add a recipient
    ...
    <table border="1">
        <tr>
            <td colspan="2">Có người liên hệ cần giúp đỡ. <br /></td>
        </tr>
        <tr>
                <td>
