...
switch ($_SERVER['SCRIPT_NAME']) {
  ...
  case "/duan-web02/backend/functions/loaisanpham/index.php":
    $CURRENT_PAGE = "backend.loaisanpham.index";
    $PAGE_TITLE = "Danh sách Loại sản phẩm";
    break;
  case "/duan-web02/backend/functions/loaisanpham/create.php":
    $CURRENT_PAGE = "backend.loaisanpham.create";
    $PAGE_TITLE = "Thêm mới Loại sản phẩm";
    break;
  case "/duan-web02/backend/functions/loaisanpham/edit.php":
